...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define('handykit',['backbone', 'underscore', 'react'], factory);
...
define('models/todo',['handykit'], function(Handykit) {
    var Todo = Handykit.Model.extend({
...
define('collections/todos',['handykit', 'models/todo', 'backbone-localStorage'], function(Handykit, Todo, LocalStorage) {
    var Todos = Handykit.Collection.extend({
...
define('views/reactive-views',['react', 'handykit', 'presenters/todo-presenter'], function(React, Handykit, todoPresenter) {
            ...
            return (
                React.DOM.div(null, 
                    ...
                    React.DOM.footer( {className:"info"}, 
                        ...
                        React.DOM.p(null, "Rewritten with Handykit by ", React.DOM.a( {href:"https://github.com/bearz"}, "Sergey Shvets"))
                    )
                )
                );
        }
    ...
    var ToggleAllCheckbox = Handykit.View({
        ...
        render: function() {
            ...
            return (
                React.DOM.div(null, 
                    React.DOM.input( {className:"toggle-all", type:"checkbox", onClick:this.handleCheckboxClick} ),
    ...
    var TodoList = Handykit.View({
        render: function() {
            ...
            return (React.DOM.ul( {className:"todo-list"}, rows));
        }
    });
    ...
    var TodoItem = Handykit.View({
        ...
        render: function() {
            ...
            return (
                React.DOM.li( {className:class_name}, 
                    React.DOM.div( {className:"view"}, 
                        React.DOM.input( {className:"toggle", type:"checkbox", checked:is_checked, onClick:this.handleToggle} ),
                        React.DOM.label( {onDoubleClick:this.enableEdit}, title),
                        React.DOM.button( {className:"destroy", onClick:this.handleDelete})
                    ),
                    React.DOM.input( {className:"edit", defaultValue:title,
    ...
    var Stats = Handykit.View({
        ...
        render: function() {
            ...
            if (this.props.todos.length === 0) {
                ...
                if (completed) {
                    completed_button = (React.DOM.button( {className:"clear-completed", onClick:this.handleClear}, "Clear completed (",completed,")"));
                }
                return (
                    React.DOM.footer( {className:"footer"}, 
                        React.DOM.span( {className:"todo-count"}, React.DOM.strong(null, remaining), " ", ' ', " ", help_text, " left"),
                        React.DOM.ul( {className:"filters"}, 
                            React.DOM.li(null, 
                                React.DOM.a( {className:this.props.selectedItem === 'all' ? "selected" : '', href:"#/"}, "All")
                            ),
                            React.DOM.li(null, 
                                React.DOM.a( {className:this.props.selectedItem === 'active' ? "selected" : '', href:"#/active"}, "Active")
                            ),
                            React.DOM.li(null, 
                                React.DOM.a( {className:this.props.selectedItem === 'completed' ? "selected" : '', href:"#/completed"}, "Completed")
                            )
                        ),
                        completed_button
                    )
...
require(['handykit', 'presenters/todo-presenter', 'views/reactive-views'], function(Handykit, TodoPresenter, RootContainer) {
